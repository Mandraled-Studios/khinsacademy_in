                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div class="md:col-span-2 lg:col-span-1" >
                        <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                            ...
                            <div>
                                <h5 class="text-xl text-gray-600 text-center"> Total Online Students Enrolled </h5>
                                <div class="mt-2 flex justify-center gap-4">
                                    <h3 class="text-3xl font-bold text-gray-700">Over 5500 </h3>
                                ...
                                <span class="block text-center text-gray-500">Compared to last 2 months</span>
                            </div>
                    ...
                    <div>
                        <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                            <h5 class="text-xl text-gray-700">Online Exams</h5>
                            <div class="my-8">
                                <h1 class="text-5xl font-bold text-gray-800">Over 1000</h1>
                                <span class="text-gray-500">Compared to last year +480</span>
                            </div>
                            <svg class="w-full transform rotate-180" viewBox="0 0 218 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                            ...
                            <div class="mt-6">
                                <h5 class="text-xl text-gray-700 text-center"> Students placed </h5>
                                <div class="mt-2 flex justify-center gap-4">
                                    <h3 class="text-3xl font-bold text-gray-700"> 90+ </h3>
                                </div>
                                <span class="block text-center text-gray-500">On average each year</span>
                            </div> 
                        </div>
                    </div>
                </div>
